...
\keywords{TensorFlow, Python, OpenCV, Face Recognition, Camera Footage}
\abstrakt{Rozpoznávanie tvárí v dohľadových systémoch predstavuje rýchlo sa rozvíjajúcu oblasť na priesečníku umelej inteligencie, počítačového videnia a bezpečnostných technológií. Táto práca prezentuje komplexnú štúdiu metód detekcie a rozpoznávania tvárí so zameraním na ich aplikáciu v kamerovom dohľade v reálnom čase. Práca začína prehľadom teoretických základov, vrátane klasických prístupov ako Eigenfaces, Fisherfaces a Local Binary Patterns (LBP), ako aj moderných techník hlbokého učenia, ako sú konvolučné neurónové siete (CNN), histogram orientovaných gradientov (HOG) a hlboké metrické učenie (Deep Metric Learning). Práca systematicky porovnáva open-source knižnice a rámce, vrátane OpenCV, dlib a TensorFlow, a hodnotí ich výkonnosť na vlastných dátových sadách zozbieraných z webových kamier a bezpečnostných kamier. Bola vytvorená vlastná dátová sada, manuálne anotovaná tak, aby odrážala reálne podmienky, a bola aplikovaná augmentácia dát na zlepšenie robustnosti modelu. Praktická časť práce detailne opisuje vývoj modulárneho systému na rozpoznávanie tvárí, ktorý integruje komponenty detekcie, rozpoznávania a správy databázy. Experimentálne výsledky demonštrujú silné stránky a obmedzenia rôznych algoritmov z hľadiska presnosti, rýchlosti a robustnosti voči náročným podmienkam, ako sú osvetlenie, póza a prekrytie. Práca sa tiež zaoberá etickými aspektmi a ochranou súkromia relevantnými pre nasadenie biometrických systémov. Zistenia prispievajú k pochopeniu súčasných schopností a výziev v oblasti rozpoznávania tvárí pre účely dohľadu, poskytujúc usmernenie pre budúci výskum a praktickú implementáciu v bezpečnostných aplikáciách.}
...
\begin{description}
    ...
    \item[AI Act] Artificial Intelligence Act (Regulation (EU) 2024/1689)
