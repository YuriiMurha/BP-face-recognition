...
The training performance of the face recognition model was evaluated on three datasets: webcam, first security camera (seccam), and second security camera (seccam\_2). The training process involved monitoring loss and accuracy metrics over multiple epochs.
The training results are presented in the following figures, which show the loss and accuracy curves for each dataset:

\begin{figure}[ht!]
    \centering
    \includegraphics[width=\textwidth]{../Files/training_webcam.png}
    \caption{Training performance on the webcam dataset.}
...
\begin{figure}[ht!]
    ...
    \caption{Training performance on the first security camera dataset.}
...
\begin{figure}[ht!]
    ...
    \caption{Training performance on the second security camera dataset.}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.5\textwidth]{../Files/codebase_workflow.png}
